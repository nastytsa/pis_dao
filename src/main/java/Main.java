...
public class Main {
    ...
    private static Dao<Client, Long> clientDao = new ClientDaoImpl();
    
    private static Dao<Master, Long> masterDao = new MasterDaoImpl();
...
//        managerDao.save(firstManager).ifPresent(firstManager::setId);
//        managerDao.save(secondManager).ifPresent(secondManager::setId);
//
